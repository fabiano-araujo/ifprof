            ...
            case R.id.itmCreatefile:
                    ...
                    option.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String file = "";
                            if (apenasUmDia){
                                file = nomeDiretorio+"/"+turma.getNomeTurma()+" - dia_"+date+".pdf";
                            }else{
                                file = nomeDiretorio+"/"+turma.getNomeTurma()+" - vários dias.pdf";
                            }
                            ...
                            if(path.exists()){
                                for (int j = 1; true; j++) {
                                    if (apenasUmDia){
                                        file = nomeDiretorio+"/"+turma.getNomeTurma()+" - dia_"+date+"("+j+")"+".pdf";
                                    }else{
                                        file = nomeDiretorio+"/"+turma.getNomeTurma()+" - vários dias("+j+").pdf";
                                    }
